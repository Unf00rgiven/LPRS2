...
def find_avr_gcc(conf):
	pl = conf.env.AVR_PATH
	cc=conf.find_program(['avr-gcc'],var='CC',path_list=pl)
	cc=conf.cmd_to_list(cc)
	conf.get_cc_version(cc,gcc=True)
	conf.env.CC_NAME='avr-gcc'
	conf.env.CC=cc

	ar=conf.find_program(['avr-ar'],path_list=pl)
	conf.env.AR=ar
	conf.env.ARFLAGS='rcs'

	prog=conf.find_program(['avr-objcopy'],path_list=pl)
	conf.env.OBJCOPY=prog
	prog=conf.find_program(['avr-objdump'],path_list=pl)
	conf.env.OBJDUMP=prog
	prog=conf.find_program(['avr-size'],path_list=pl)
	conf.env.SIZE=prog
	prog=conf.find_program(['avr-nm'],path_list=pl)
	conf.env.SIZE=prog

	#prog=conf.find_program(['avr-ld'],path_list=pl)
	#conf.env.LD=prog
